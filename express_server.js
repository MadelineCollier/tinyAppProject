...
//creates user_id session once the login form is filled out
...
// //deletes the user_id session (effectively loggin out the user)
...
app.get("/urls/:id", (req, res) => {
  let templateVars = {
    userEmail: getUserEmailById(req.session.user_id),
    urls: urlDatabase,
